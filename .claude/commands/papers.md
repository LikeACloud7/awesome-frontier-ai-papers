# Daily AI Paper Collection

Collect and review AI/ML papers from arXiv and HuggingFace.

## How to Use

1. Run the paper collection script:

```bash
{PROJECT_PATH}/venv/bin/python {PROJECT_PATH}/scripts/fetch_papers.py
```
...
- Results displayed in beautiful tab UI
